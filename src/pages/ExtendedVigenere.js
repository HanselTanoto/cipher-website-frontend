...
export default function ExtendedVigenere() {
    ...
    const decode = async (e) => {
        ...
        let response = null
        try {
            response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}extendedvigenere/decrypt`, formdata)
    ...
    return (
        <div id = "cipher-page">
            <div className="container-form" id="container-form">
                <Card className="form">
                    <Card.Body>
                        <Card.Header>Extended Vigenere (ASCII) Encoder & Decoder</Card.Header>
